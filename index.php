                    ...
                    <form class="row g-3 needs-validation" action="" method="post" novalidate>
                      <div class="col-12">
                        ...
                        <div class="input-group has-validation">
                          ...
                          <div class="invalid-feedback">Silahkan masukkan email dengan benar!</div>
                        </div>
                      </div>
                      ...
                      <div class="col-12">
                        <button class="btn btn-primary w-100"value="login now" name="submit" type="submit">Login</button>
                      </div>
                      <?php
                      if(isset($error)){
                      ...
                      ?>
                      <div class="col-12">
                        <p class="small mb-0">Belum punya akun? <a href="register.php">Registrasi</a></p>
                      </div>
                    </form>
                  </div>
                </div>
